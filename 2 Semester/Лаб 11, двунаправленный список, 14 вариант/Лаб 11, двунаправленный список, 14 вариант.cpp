...
int main()
{
    ...
    cin >> size;
    cout << "Enter the values ​​of the items in the list: ";
    ListElem* list = createList(size);
    cout << "List output: " << endl;
    printList(list, size);
    cout << "At what position to add the element: ";
    cin >> pos;
    insert_element(list, pos, 1, size);
    cout << "List output: " << endl;
    printList(list, size);
    cout << "At what position to add elements and how many of them: ";
    cin >> pos;
    cin >> k;
    insert_elements(list, pos, k, size);
    cout << "List output: " << endl;
    printList(list, size);
    cout << "At what position need to delete the element: ";
    cin >> pos;
    delete_element(list, pos, 1, size);
    cout << "List output: " << endl;
    printList(list, size);
    cout << "At what position to delete elements and how many of them: ";
    cin >> pos;
    cin >> k;
    delete_elements(list, pos, k, size);
    cout << "List output: " << endl;
    printList(list, size);
    cout << "What element need to find: ";
    cin >> element;
